...
\author[M. Godbout, A. Bouras]{Mathieu Godbout et Alexandre Bouras}
\institute{\texttt{\{mathieu.godbout.3, alexandre.bouras.1\}@ulaval.ca}}
\date[]{15 mai 2023}
	...
	\begin{center}
		\begin{columns}
			\begin{column}{0.4\textwidth}
				\centering
				\includegraphics[width=\textwidth]{MathieuGodbout.jpg}
			\end{column}
			\begin{column}{0.4\textwidth}
				\centering
				\includegraphics[width=\textwidth]{AlexandreBouras.png}
			\end{column}
		\end{columns}
	\end{center}
\end{frame}
